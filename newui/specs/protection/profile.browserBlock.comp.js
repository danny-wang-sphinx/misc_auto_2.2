...
describe('protection web: block by browsers', ()=> {
  ...
  let uiStatus
  let tests = [
    {browserStatus:true,webviewStatus:false,confValue:'browser',reject:true},
    {browserStatus:false,webviewStatus:true,confValue:'webview',reject:false},
  ]
  tests.forEach((test) => {
  ...
  function set(browserStatus, webviewStatus) {
    ...
    uiStatus = profileUtil.browserBlock(name)
  }
